...
- Callers using `MessageBody.Bytes` still allocate — they need to migrate to `MessageBody.Memory` to get the benefit. This is an incremental migration, not a flag day.
