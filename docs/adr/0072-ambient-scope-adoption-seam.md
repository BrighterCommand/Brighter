...
#### 2c. What borrowing does to Brighter's own registrations, stated as an answer rather than left to be inferred
...
#### 2d. The residue is stated rather than claimed away, and there are three parts to it
