...
Sharing one artefact cache between the mapper and the transforms is harmless — a mapper and a transform are different types — and it is what makes ADR 0072's borrowed scope work without a second mechanism.
