...
namespace Paramore.Brighter.Outbox.DynamoDB
{
    ...
    public class SparseOutstandingIndexMessageItem
    {
        /// <summary>
        /// The message body
        /// </summary>
        ...
        public SparseOutstandingIndexMessageItem()
        {
            /*Deserialization*/
        }

        public SparseOutstandingIndexMessageItem(Message message, int shard = 0, long? expiresAt = null)
        {
