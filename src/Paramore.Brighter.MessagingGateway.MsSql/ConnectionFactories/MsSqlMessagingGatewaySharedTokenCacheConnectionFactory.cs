...
{
    public class MsSqlMessagingGatewaySharedTokenCacheConnectionFactory : IMsSqlMessagingGatewayConnectionFactory
    {
        ...
        public MsSqlMessagingGatewaySharedTokenCacheConnectionFactory(string connectionString,
        ...
        public MsSqlMessagingGatewaySharedTokenCacheConnectionFactory(string connectionString, string azureUserName,
