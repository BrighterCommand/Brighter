...
{
    public class MsSqlMessagingGatewayManagedIdentityConnectionFactory : IMsSqlMessagingGatewayConnectionFactory
    {
        private readonly string _connectionString;
        private readonly string[] _authenticationTokenScopes;

        public MsSqlMessagingGatewayManagedIdentityConnectionFactory(string connectionString, string authenticationTokenScopes = "https://database.windows.net/.default")
        {
