...
{
    public class MySqlQueries : IRelationDatabaseOutboxQueries, IRelationalDatabaseOutboxCausationQueries
    {
        ...
        public string AddCommand { get; } =
            "INSERT INTO {0} (`MessageId`, `MessageType`, `Topic`, `Timestamp`, `CorrelationId`, `ReplyTo`, `ContentType`, `PartitionKey`, `HeaderBag`, `Body`, `Source`, `Type`, `DataSchema`, `Subject`, `TraceParent`, `TraceState`, `Baggage`, `WorkflowId`, `JobId`) " +
