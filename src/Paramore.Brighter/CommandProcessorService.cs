...
{
    public class CommandProcessorService : IAmACommandProcessorService
    {
        ...
        /// <param name="requestContextFactory">The request context factory.</param>
        /// <param name="policyRegistry">The policy registry.</param>
        /// <param name="handlerFactory">The Singleton Handler Factory.</param>
        /// <param name="mapperRegistry">The mapper registry.</param>
        /// <param name="messageProducer">The messaging gateway.</param>
        ...
        public CommandProcessorService(
            ...
            InboxConfiguration inboxConfiguration = null)
            : this(subscriberRegistry, requestContextFactory, policyRegistry)
        {
        ...
        public CommandProcessorService(
            ...
            IAmAFeatureSwitchRegistry featureSwitchRegistry = null,
            InboxConfiguration inboxConfiguration = null)
            : this(subscriberRegistry, requestContextFactory, policyRegistry, featureSwitchRegistry)
        {
            _mapperRegistry = mapperRegistry;
            _asyncOutbox = asyncOutbox;
            _asyncMessageProducer = asyncMessageProducer;
            ...
            where T : class, ICall where TResponse : class, IResponse
        {
                        ...
                        routingKey: new RoutingKey(routingKey))))
            {
                ...
                if (responseMessage.Header.MessageType != MessageType.MT_NONE)
                {
                    ...
                    Send(response, _handlerFactory); //TODO: Look further into this as for callback passing in a potentially Scoped Factory is Dangerous
                }
