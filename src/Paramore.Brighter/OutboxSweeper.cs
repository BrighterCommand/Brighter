...
namespace Paramore.Brighter
{
    public class OutboxSweeper
    {
        ...
        public void Sweep()
        {
            ...
            _commandProcessor.ClearOutbox(_batchSize, _millisecondsSinceSent, _args, true);
        }
        ...
        {
            ApplicationTelemetry.ActivitySource.StartActivity(IMPLICITCLEAROUTBOX, ActivityKind.Server);
            _commandProcessor.ClearAsyncOutbox(_batchSize, _millisecondsSinceSent, _useBulk, _args, true);
        }
    }
}
