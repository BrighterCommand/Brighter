namespace Paramore.Brighter
{
    ...
    /// Use <see cref="Connection "/>for consumer specific logic, specializing it for your platform
    /// Use <see cref="ProducerConnection"/> for producer specific logic, specializing it for your platform.
