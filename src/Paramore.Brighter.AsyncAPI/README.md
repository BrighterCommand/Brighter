...
`Paramore.Brighter.AsyncAPI` generates an AsyncAPI 3.0 document from your Brighter configuration.
...
This writes pretty-printed JSON to `asyncapi.json` and returns the generated `AsyncApiDocument`.
...
- `Servers`: optional AsyncAPI server definitions
