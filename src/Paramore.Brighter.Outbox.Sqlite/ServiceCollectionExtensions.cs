...
namespace Paramore.Brighter.Outbox.Sqlite
{
    public static class ServiceCollectionExtensions
    {
            ...
            )
        {
            ...
            brighterBuilder.Services.Add(new ServiceDescriptor(typeof(IAmARelationalDbConnectionProvider), typeof(SqliteConnectionProvider), serviceLifetime));
            ...
            var outbox = new SqliteOutbox(configuration, new SqliteConnectionProvider(configuration)); 
