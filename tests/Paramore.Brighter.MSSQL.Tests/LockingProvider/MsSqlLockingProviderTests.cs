...
public class MsSqlLockingProviderTests
{
    ...
    {
        var provider = new MsSqlLockingProvider((MsSqlConnectionProvider)_msSqlTestHelper.ConnectionProvider);
    ...
    {
        var provider1 = new MsSqlLockingProvider((MsSqlConnectionProvider)_msSqlTestHelper.ConnectionProvider);
        var provider2 = new MsSqlLockingProvider((MsSqlConnectionProvider)_msSqlTestHelper.ConnectionProvider);
        var resource = "Sweeper";
    ...
    {
        var connectionProvider = (MsSqlConnectionProvider)_msSqlTestHelper.ConnectionProvider;
