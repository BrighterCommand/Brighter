...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.MsSql.MsSqlSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.MsSql.MsSqlSubscription subscription);
    ...
    Message GetMessageFromInvalidChannel(Paramore.Brighter.MessagingGateway.MsSql.MsSqlSubscription subscription);
