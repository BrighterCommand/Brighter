...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.MsSql.MsSqlSubscription subscription, CancellationToken cancellationToken = default);
