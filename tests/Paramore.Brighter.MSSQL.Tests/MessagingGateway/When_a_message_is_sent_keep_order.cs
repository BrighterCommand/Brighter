...
namespace Paramore.Brighter.MSSQL.Tests.MessagingGateway
{
    ...
    public class OrderTest : IAsyncDisposable, IDisposable
    {
        ...
        public OrderTest()
        {
            ...
            _consumer = new MsSqlMessageConsumerFactory(testHelper.QueueConfiguration, loggerFactory: global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance).Create(sub);
        }
