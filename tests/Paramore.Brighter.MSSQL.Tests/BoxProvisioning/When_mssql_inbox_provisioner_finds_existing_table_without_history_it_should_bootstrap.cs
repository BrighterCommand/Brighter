...
public class When_mssql_inbox_provisioner_finds_existing_table_without_history_it_should_bootstrap : IAsyncLifetime
{
    private readonly string _connectionString;
    private readonly string _tableName;
    private readonly MsSqlInboxProvisioner _provisioner;

    public When_mssql_inbox_provisioner_finds_existing_table_without_history_it_should_bootstrap()
    {
