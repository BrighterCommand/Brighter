...
public class When_mssql_box_provisioning_uses_connection_name_it_should_resolve_from_configuration : IAsyncLifetime
{
    private readonly string _connectionString;
    private readonly string _tableName;

    public When_mssql_box_provisioning_uses_connection_name_it_should_resolve_from_configuration()
    {
