...
public class When_mssql_outbox_provisioner_detects_payload_mode_mismatch_it_should_throw : IAsyncLifetime
{
    private readonly string _connectionString;
    private readonly string _tableName;

    public When_mssql_outbox_provisioner_detects_payload_mode_mismatch_it_should_throw()
    {
