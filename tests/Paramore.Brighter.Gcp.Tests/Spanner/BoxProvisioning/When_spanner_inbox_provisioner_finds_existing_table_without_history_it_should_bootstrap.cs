...
public class When_spanner_inbox_provisioner_finds_existing_table_without_history_it_should_bootstrap
{
    ...
    public When_spanner_inbox_provisioner_finds_existing_table_without_history_it_should_bootstrap()
    {
    ...
    public async Task Should_bootstrap_with_synthetic_history()
    {
        ...
        using (var setupConn = CreateConnection())
        {
            ...
            var ddl = setupConn.CreateDdlCommand(SpannerInboxBuilder.GetDDL(_tableName));
