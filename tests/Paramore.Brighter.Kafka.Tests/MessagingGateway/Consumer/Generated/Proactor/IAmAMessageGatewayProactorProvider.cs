...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.Kafka.KafkaSubscription subscription, CancellationToken cancellationToken = default);
