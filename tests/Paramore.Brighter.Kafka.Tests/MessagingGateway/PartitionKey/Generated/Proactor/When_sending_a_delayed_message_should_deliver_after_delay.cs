...
public class WhenSendingADelayedMessageShouldDeliverAfterDelayAsync : IAsyncLifetime
{
    ...
    [Fact(Skip = "Deferred: #4240 — delayed send not yet conformant for Kafka / PartitionKey (maintainer sign-off)")]
    public async Task When_sending_a_delayed_message_should_deliver_after_delay_async()
    {
        ...
        var beforeDelay = await _channel.ReceiveAsync(TimeSpan.FromMilliseconds(15000));
