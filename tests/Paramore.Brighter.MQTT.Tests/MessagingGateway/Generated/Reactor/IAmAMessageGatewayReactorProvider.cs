...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.Publication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription);
    ...
    Message GetMessageFromInvalidChannel(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription);
