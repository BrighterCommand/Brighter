...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.Publication CreatePublication(RoutingKey routingKey, OnMissingChannel makeChannels = OnMissingChannel.Create);
    ...
    Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel,
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.Publication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.MQTT.MqttSubscription subscription, CancellationToken cancellationToken = default);
