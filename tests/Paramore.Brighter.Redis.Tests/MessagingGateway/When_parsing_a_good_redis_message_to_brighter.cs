...
public class RedisGoodMessageParsingTests
{
    ...
    {
        Message message = new RedisMessageCreator(logger: global::Microsoft.Extensions.Logging.LoggerFactoryExtensions.CreateLogger<global::Paramore.Brighter.MessagingGateway.Redis.RedisMessageCreator>(global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance)).CreateMessage(GoodMessage);
