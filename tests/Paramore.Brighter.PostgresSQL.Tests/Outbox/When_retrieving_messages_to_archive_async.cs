...
{
    private readonly PostgresSqlTestHelper  _mySqlTestHelper;
    ...
    {
        _mySqlTestHelper = new PostgresSqlTestHelper();
        _mySqlTestHelper.SetupMessageDb();

        _sqlOutbox = new PostgreSqlOutbox(_mySqlTestHelper.Configuration);
