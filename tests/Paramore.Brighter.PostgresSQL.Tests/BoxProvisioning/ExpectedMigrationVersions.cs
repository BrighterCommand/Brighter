...
/// </summary>
/// <remarks>
/// PostgreSQL inbox stays at V1 only — it was born with <c>ContextKey</c>, so the V2 migration
/// that adds <c>ContextKey</c> to other backends has no analogue here.
/// </remarks>
internal static class ExpectedMigrationVersions
{
    public const int OutboxLatest = 7;
    public const int InboxLatest = 1;
}
