...
public class WhenRequeuingAFailedMessageShouldBeRedelivered : IDisposable
{
    ...
    public WhenRequeuingAFailedMessageShouldBeRedelivered()
    {
    ...
    [Fact(Skip = "Deferred: #NNNN — canonical plain requeue not yet conformant for PostgresSQL / PostgresMessagingGateway (maintainer sign-off)")]
    public void When_requeuing_a_failed_message_should_be_redelivered()
    {
        ...
        var requeued = _channel.Requeue(received);
