...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.MessagingGateway.Postgres.PostgresPublication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.Postgres.PostgresSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.Postgres.PostgresSubscription subscription);
    ...
    Message GetMessageFromInvalidChannel(Paramore.Brighter.MessagingGateway.Postgres.PostgresSubscription subscription);
