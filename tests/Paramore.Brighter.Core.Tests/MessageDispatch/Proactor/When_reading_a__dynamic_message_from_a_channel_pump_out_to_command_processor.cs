...
namespace Paramore.Brighter.Core.Tests.MessageDispatch.Reactor
{
    public class MessagePumpToCommandProcessorDynamicMappingTestsAsync
    {
        ...
        public MessagePumpToCommandProcessorDynamicMappingTestsAsync()
        {
            ...
            var messagerMapperRegistry = new MessageMapperRegistry(null, new SimpleMessageMapperFactoryAsync(type => type switch
            {
            ...
            _messagePump = new ServiceActivator.Proactor(_commandProcessor, (message) => message switch
            {
