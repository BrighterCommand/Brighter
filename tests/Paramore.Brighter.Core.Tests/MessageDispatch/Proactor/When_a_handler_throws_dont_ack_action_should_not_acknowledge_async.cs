...
namespace Paramore.Brighter.Core.Tests.MessageDispatch.Proactor
{
    public class MessagePumpCommandDontAckActionTestsAsync
    {
        ...
        public async Task When_A_Handler_Throws_DontAck_Action_Should_Not_Acknowledge_Async()
        {
            ...
            // Nack re-enqueues immediately, so the pump can already be on its second delivery
            // by the time the test thread resumes — assert at-least-once, not exactly-once.
