...
{
    public class CommandProcessorWithFeatureSwitchOffByConfigInPipelineTests
    {
        ...
        public CommandProcessorWithFeatureSwitchOffByConfigInPipelineTests()
        {
            ...
            IAmAFeatureSwitchRegistry featureSwitchRegistry = FluentConfigRegistryBuilder.With().StatusOf<MyFeatureSwitchedConfigHandler>().Is(FeatureSwitchStatus.Off).StatusOf<MyFeatureSwitchedConfigHandlerAsync>().Is(FeatureSwitchStatus.Off).Build();
        ...
        [Test]
        public async Task When_Sending_A_Command_To_The_Processor_When_A_Feature_Switch_Is_Off_By_Fluent_Config()
        {
