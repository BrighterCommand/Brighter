...
{
    public class FeatureSwitchByConfigMissingConfigStrategySilentOffTests
    {
        ...
        [Test]
        public async Task When_Sending_A_Command_To_The_Processor_When_A_Feature_Switch_Has_No_Config_And_Strategy_Is_SilentOff()
        {
