...
{
    public class CommandProcessorWithFeatureSwitchOnInPipelineTests
    {
        ...
        [Test]
        public async Task When_Sending_A_Command_To_The_Processor_When_A_Feature_Switch_Is_On()
        {
            _commandProcessor.Send(_myCommand);
            await Assert.That(MyFeatureSwitchedOnHandler.DidReceive(_myCommand)).IsTrue();
        }
        ...
        public async Task When_Sending_A_Async_Command_To_The_Processor_When_A_Feature_Switch_Is_On()
        {
            ...
            await Assert.That(MyFeatureSwitchedOnHandlerAsync.DidReceive()).IsTrue();
        }
    }
}