...
{
    public class CommandProcessorWithFeatureSwitchOnByConfigInPipelineTests
    {
        ...
        public CommandProcessorWithFeatureSwitchOnByConfigInPipelineTests()
        {
            ...
            IAmAFeatureSwitchRegistry fluentConfig = FluentConfigRegistryBuilder.With().StatusOf<MyFeatureSwitchedConfigHandler>().Is(FeatureSwitchStatus.On).StatusOf<MyFeatureSwitchedConfigHandlerAsync>().Is(FeatureSwitchStatus.On).Build();
