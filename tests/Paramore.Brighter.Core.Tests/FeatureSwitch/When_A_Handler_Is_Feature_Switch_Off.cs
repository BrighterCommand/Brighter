...
{
    public class CommandProcessorWithFeatureSwitchOffInPipelineTests
    {
        ...
        [Test]
        public async Task When_Sending_A_Command_To_The_Processor_When_A_Feature_Switch_Is_Off()
        {
            _commandProcessor.Send(_myCommand);
            await Assert.That(MyFeatureSwitchedOffHandler.DidReceive()).IsFalse();
        }
        ...
        public async Task When_Sending_A_Async_Command_To_The_Processor_When_A_Feature_Switch_Is_Off()
        {
            ...
            await Assert.That(MyFeatureSwitchedOffHandlerAsync.DidReceive()).IsFalse();
        }
    }
}