...
namespace Paramore.Brighter.Core.Tests.ControlBus
{
    public class ControlBusTests
    {
        ...
        {
            var topic = new RoutingKey(Environment.MachineName + System.Reflection.Assembly.GetEntryAssembly()?.GetName());
        ...
        [Test]
        public async Task When_we_build_a_control_bus_we_can_send_configuration_messages_to_it()
        {
