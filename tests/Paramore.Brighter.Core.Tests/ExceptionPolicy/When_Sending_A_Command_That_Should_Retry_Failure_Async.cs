...
namespace Paramore.Brighter.Core.Tests.ExceptionPolicy
{
    public class CommandProcessorWithRetryPolicyAsyncTests
    {
        ...
        public CommandProcessorWithRetryPolicyAsyncTests()
        {
            ...
            var policy = Policy.Handle<DivideByZeroException>().WaitAndRetryAsync([TimeSpan.FromMilliseconds(10), TimeSpan.FromMilliseconds(20), TimeSpan.FromMilliseconds(30)], (exception, timeSpan) => _retryCount++);
        ...
        public async Task When_Sending_A_Command_That_Should_Retry_Failure_Async()
        {
            ...
            await Assert.That(zeroHandlerAsync!.ShouldReceive(_myCommand)).IsTrue();
