...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.MessagingGateway.Pulsar.PulsarPublication CreatePublication(RoutingKey routingKey, OnMissingChannel makeChannels = OnMissingChannel.Create);
    ...
    Paramore.Brighter.MessagingGateway.Pulsar.PulsarSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel, bool setupDeadLetterQueue = false);
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.Pulsar.PulsarSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.MessagingGateway.Pulsar.PulsarPublication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.Pulsar.PulsarSubscription subscription, CancellationToken cancellationToken = default);
