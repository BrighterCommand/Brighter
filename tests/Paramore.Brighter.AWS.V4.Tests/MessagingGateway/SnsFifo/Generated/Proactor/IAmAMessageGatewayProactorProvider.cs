...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.MessagingGateway.AWSSQS.V4.SnsPublication CreatePublication(RoutingKey routingKey, OnMissingChannel makeChannels = OnMissingChannel.Create);
    ...
    Paramore.Brighter.MessagingGateway.AWSSQS.V4.SqsSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel,
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.AWSSQS.V4.SqsSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.AWSSQS.V4.SqsSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.MessagingGateway.AWSSQS.V4.SnsPublication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.AWSSQS.V4.SqsSubscription subscription, CancellationToken cancellationToken = default);
