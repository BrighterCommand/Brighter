...
namespace Paramore.Brighter.NATS.Tests.MessagingGateway.Reactor;
...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.MessagingGateway.NATS.NatsPublication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.NATS.NatsSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.NATS.NatsSubscription subscription);
}
