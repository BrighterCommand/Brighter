...
[Trait("Category", "NATS")]
[Collection("NATSMessagingGateway")]
public class WhenRequeuingAFailedMessageShouldReceiveMessageAgainAsync : IAsyncLifetime
{
    ...
    private Paramore.Brighter.MessagingGateway.NATS.NatsSubscription? _subscription;
    private Paramore.Brighter.MessagingGateway.NATS.NatsPublication? _publication;
    ...
    {
        _messageGatewayProvider = new Paramore.Brighter.NATS.Tests.MessagingGateway.NatsMessageGatewayProvider();
    ...
    public async Task When_requeuing_a_failed_message_should_receive_message_again_async()
    {
        ...
        for (var i = 0; i < 10; i++)
        {
            requeued = await _channel.ReceiveAsync(TimeSpan.FromMilliseconds(4000));
