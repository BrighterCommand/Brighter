...
namespace Paramore.Brighter.NATS.Tests.MessagingGateway.Proactor;
...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.MessagingGateway.NATS.NatsPublication CreatePublication(RoutingKey routingKey, OnMissingChannel makeChannels = OnMissingChannel.Create);
    ...
    Paramore.Brighter.MessagingGateway.NATS.NatsSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel, bool setupDeadLetterQueue = false);
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.NATS.NatsSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.MessagingGateway.NATS.NatsPublication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.NATS.NatsSubscription subscription, CancellationToken cancellationToken = default);
