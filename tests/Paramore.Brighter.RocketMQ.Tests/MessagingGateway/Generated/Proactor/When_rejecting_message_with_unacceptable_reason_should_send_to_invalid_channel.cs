...
public class WhenRejectingMessageWithUnacceptableReasonShouldSendToInvalidChannelAsync : IAsyncLifetime
{
    ...
    [Fact(Skip = "Deferred: #NNNN — reject with unacceptable reason to invalid channel not yet conformant for RocketMQ / RocketMQMessagingGateway (maintainer sign-off)")]
