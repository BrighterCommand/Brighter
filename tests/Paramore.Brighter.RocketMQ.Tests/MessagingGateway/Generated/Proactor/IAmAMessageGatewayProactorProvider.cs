...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.MessagingGateway.RocketMQ.RocketSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel,
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.RocketMQ.RocketSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.RocketMQ.RocketSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.MessagingGateway.RocketMQ.RocketMqPublication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.RocketMQ.RocketSubscription subscription, CancellationToken cancellationToken = default);
