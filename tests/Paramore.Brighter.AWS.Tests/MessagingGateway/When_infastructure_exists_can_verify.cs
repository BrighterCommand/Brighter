...
namespace Paramore.Brighter.AWS.Tests.MessagingGateway
{
    ...
    public class AWSValidateInfrastructureTests : IDisposable
    {
        ...
        public AWSValidateInfrastructureTests()
        {
            ...
            var fifoMessageGroupId = Guid.NewGuid().ToString();
            ...
            _fifoMessageProducer = new SqsMessageProducer(
                awsConnection,
                new SnsPublication
                {
                    FindTopicBy = TopicFindBy.Name,
                    MakeChannels = OnMissingChannel.Validate,
                    Topic = new RoutingKey(fifoTopicName),
        ...
        [Fact]
        public async Task When_infrastructure_exists_can_verify_for_fifo()
        {
            //arrange
