...
namespace Paramore.Brighter.AWS.Tests.MessagingGateway.SnsStandard.Reactor;
...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.MessagingGateway.AWSSQS.SnsPublication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.AWSSQS.SqsSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.AWSSQS.SqsSubscription subscription);
    ...
    Message GetMessageFromInvalidChannel(Paramore.Brighter.MessagingGateway.AWSSQS.SqsSubscription subscription);
