...
public class AwsAssumeInfrastructureTests : IDisposable, IAsyncDisposable
{
    ...
    public AwsAssumeInfrastructureTests()
    {
        ...
        _messageProducer = new SnsMessageProducer(awsConnection,
            new SnsPublication { MakeChannels = OnMissingChannel.Assume }, loggerFactory: global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance);

        _consumer = new SqsMessageConsumer(awsConnection, channel.Name.ToValidSQSQueueName(), loggerFactory: global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance);
    }
