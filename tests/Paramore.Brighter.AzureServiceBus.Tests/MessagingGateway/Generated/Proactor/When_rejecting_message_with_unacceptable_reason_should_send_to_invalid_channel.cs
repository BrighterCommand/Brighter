...
public class WhenRejectingMessageWithUnacceptableReasonShouldSendToInvalidChannelAsync : IAsyncLifetime
{
    ...
    [Fact(Skip = "Deferred: #4240 — reject with unacceptable reason to invalid channel not yet conformant for AzureServiceBus / AzureServiceBusMessagingGateway (maintainer sign-off)")]
