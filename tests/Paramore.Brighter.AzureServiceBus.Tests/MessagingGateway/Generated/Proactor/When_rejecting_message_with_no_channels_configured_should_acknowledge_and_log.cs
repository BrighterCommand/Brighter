...
public class WhenRejectingMessageWithNoChannelsConfiguredShouldAcknowledgeAndLogAsync : IAsyncLifetime
{
    ...
    [Fact(Skip = "Deferred: #4240 — no channels configured: acknowledge and log not yet conformant for AzureServiceBus / AzureServiceBusMessagingGateway (maintainer sign-off)")]
