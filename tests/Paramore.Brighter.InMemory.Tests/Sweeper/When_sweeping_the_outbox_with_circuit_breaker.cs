...
namespace Paramore.Brighter.InMemory.Tests.Sweeper
{
    ...
    public class SweeperTestsWithCircuitBreaker
    {
        ...
        public SweeperTestsWithCircuitBreaker()
        {
            ...
            InMemoryMessageProducer messageProducer = new(_internalBus, global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance, new Publication { Topic = _routingKeyOne, RequestType = typeof(MyEvent) });
            ...
            InMemoryMessageProducer messageProducerTwo = new(_internalBus, global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance, new Publication { Topic = _routingKeyTwo, RequestType = typeof(MyEvent) });
