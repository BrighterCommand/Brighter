...
public class InMemoryConsumerRejectWithDeadLetterTestsAsync 
{
    ...
    public async Task When_rejecting_a_message_with_a_dead_letter_channel_async()
    {
        ...
        var consumer = new InMemoryMessageConsumer(routingKey, bus, timeProvider, global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance, deadLetterTopic, ackTimeout: TimeSpan.FromMilliseconds(1000)) as IAmAMessageConsumerAsync;
