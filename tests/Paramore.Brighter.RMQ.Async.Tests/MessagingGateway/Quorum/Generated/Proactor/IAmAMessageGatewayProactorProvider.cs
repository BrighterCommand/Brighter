...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.RMQ.Async.RmqSubscription subscription, CancellationToken cancellationToken = default);
