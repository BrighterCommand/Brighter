...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqPublication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription);
    ...
    Message GetMessageFromInvalidChannel(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription);
