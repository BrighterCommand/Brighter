...
public interface IAmAMessageGatewayProactorProvider
{
    ...
    Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqPublication CreatePublication(RoutingKey routingKey, OnMissingChannel makeChannels = OnMissingChannel.Create);
    ...
    Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription CreateSubscription(RoutingKey routingKey, ChannelName channelName, OnMissingChannel makeChannel,
    ...
    Task<Message> GetMessageFromDeadLetterQueueAsync(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<Message> GetMessageFromInvalidChannelAsync(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription, CancellationToken cancellationToken = default);
    ...
    Task<IAmAMessageProducerAsync> CreateProducerAsync(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqPublication publication, CancellationToken cancellationToken = default);
    ...
    Task<IAmAChannelAsync> CreateChannelAsync(Paramore.Brighter.MessagingGateway.RMQ.Sync.RmqSubscription subscription, CancellationToken cancellationToken = default);
