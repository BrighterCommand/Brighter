...
public class SqsSchedulingRequestAsyncTest : IAsyncDisposable
{
    ...
    public SqsSchedulingRequestAsyncTest()
    {
        ...
        _messageProducer = new SqsMessageProducer(
            awsConnection,
            new SqsPublication { QueueAttributes = sqsAttributes, MakeChannels = OnMissingChannel.Create }, loggerFactory: global::Microsoft.Extensions.Logging.Abstractions.NullLoggerFactory.Instance);
