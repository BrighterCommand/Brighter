...
- [ ] **TEST + IMPLEMENT: MySQL outbox bootstrap upgrades pre-V7 tables to V7**
...
- [ ] **TEST + IMPLEMENT: Two MySQL provisioners racing produce exactly one synthetic history row for outbox and inbox**
...
- [ ] **TEST + IMPLEMENT: SQLite runner rolls back all migrations and history rows on mid-chain failure**
...
- [ ] **IMPLEMENT: Add rule to box_provisioning.md enforcing migration + drift test for every new column**
...
- [ ] **IMPLEMENT: Release notes entry for IAmABoxMigration interface break**
...
- [ ] **IMPLEMENT: Update spec 0023's review-code.md to mark R2, R4, R5 as closed by spec 0027**
