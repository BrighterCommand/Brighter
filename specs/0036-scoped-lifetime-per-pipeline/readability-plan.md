...
| **3** | the rewrite, **one ADR per session**, worst-first: 0072, 0071, 0070, then 0074, 0075, 0076, 0073 | ~7 — ✅ **0072 done, `f30358c5e`**; ✅ **0071 done, `3537c68cd`**; ✅ **0070 done, `fb27c81bb`**; ✅ **0074 done, `e3ed130b0`**; ✅ **0075 done, `992537bcc`** (preceded by `0583c5af8`, the X1 sweep); **2 to go — 0076, 0073** |
