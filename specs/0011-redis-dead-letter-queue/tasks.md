...
- [ ] **TEST + IMPLEMENT: RedisSubscription exposes DLQ and invalid message routing keys**
...
- [ ] **TEST + IMPLEMENT: Rejecting a message with no DLQ or invalid message channel configured removes from inflight**
...
- [ ] **Run full Redis test suite to verify no regressions**
