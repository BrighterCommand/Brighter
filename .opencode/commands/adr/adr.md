...
Use the question tool to gather the key information needed for the ADR:
...
[Scans docs/adr/ and finds highest is 0036]
Next ADR number: 0037

[Checks for current spec and finds specs/0001-kafka-dead-letter-queue/]
...
[Creates docs/adr/0037-kafka-message-serialization-strategy.md]
