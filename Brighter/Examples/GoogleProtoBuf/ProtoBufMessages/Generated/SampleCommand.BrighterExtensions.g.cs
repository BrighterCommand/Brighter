...
{
   /// <summary>
   /// Brigher ICommand interface implementation
   ...
   /// </summary>
   public sealed partial class SampleCommand : ICommand
   {
   ...
   /// <summary>
   /// Auto-generated brighter mapping class for SampleCommand to use
   /// Brighter's serialization and deserialization logic.
   /// </summary>
   public partial class SampleCommandBrighterMapper : IAmAMessageMapper<SampleCommand>
   {
      ...
      public Message MapToMessage(SampleCommand request)
      {
         _header = new MessageHeader(messageId: request.Id, topic: SampleCommand.Descriptor.Name, messageType: MessageType.MT_COMMAND);
         ...
         Message msg = new Message(
            header: _header,
            body: new MessageBody(request.ToByteArray(), SampleCommand.Descriptor.Name));
         return msg;
      }


      public SampleCommand MapToRequest(Message message)
      {
         return SampleCommand.Parser.ParseFrom(message.Body.Bytes);
      }
      ...
      /// </summary>
      partial void AlterMessageHeader(SampleCommand request);
   }
}
